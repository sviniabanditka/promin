...
const D: Record<string, Entry> = {
  ...
  'set.unlink': ['Відв’язати всі телефони', 'Отвязать все телефоны', 'Unlink all phones'],
  'set.unlink_one': ['Відв’язати', 'Отвязать', 'Unlink'],
  'set.unlink_one_confirm': ['Відв’язати {name} від профілю?', 'Отвязать {name} от профиля?', 'Unlink {name} from the profile?'],
  'set.no_name': ['Без імені', 'Без имени', 'No name'],
  'set.invite_phone': ['Запросити інший телефон', 'Пригласить другой телефон', 'Invite another phone'],
  'set.invite_hint': ['Надішліть посилання рідним — їхній Telegram отримає той самий профіль, пульт і бібліотеку.', 'Отправьте ссылку близким — их Telegram получит тот же профиль, пульт и библиотеку.', 'Send the link to family — their Telegram gets the same profile, remote and library.'],
  'set.invite_text': ['Приєднуйся до нашого Promin: відкрий посилання і натисни Start', 'Присоединяйся к нашему Promin: открой ссылку и нажми Start', 'Join our Promin: open the link and press Start'],
  'set.unlink_confirm': [
  ...
  'set.playback': ['Відтворення', 'Воспроизведение', 'Playback'],
  'set.quality': ['Якість за замовчуванням', 'Качество по умолчанию', 'Default quality'],
  'set.engine': ['Рушій плеєра', 'Движок плеера', 'Player engine'],
  'set.engine_native': ['Нативний', 'Нативный', 'Native'],
  'set.subs_size': ['Розмір субтитрів', 'Размер субтитров', 'Subtitle size'],
  'set.subs_small': ['Малий', 'Маленький', 'Small'],
  'set.subs_medium': ['Середній', 'Средний', 'Medium'],
  'set.subs_large': ['Великий', 'Большой', 'Large'],
  'set.speed': ['Швидкість', 'Скорость', 'Speed'],
  'set.screen': ['Екран', 'Экран', 'Screen'],
  'set.night': ['Нічний режим', 'Ночной режим', 'Night mode'],
  'set.night_dim': ['Затемнення', 'Затемнение', 'Dimming'],
  'set.screensaver': ['Заставка', 'Заставка', 'Screensaver'],
  'set.this_tv': ['Цей телевізор', 'Этот телевизор', 'This TV'],
  'set.legacy': ['Режим старого ТВ', 'Режим старого ТВ', 'Old TV mode'],
  'set.reduce_motion': ['Менше анімацій', 'Меньше анимаций', 'Reduce motion'],
  'set.debug': ['Режим діагностики', 'Режим диагностики', 'Diagnostics mode'],
  'set.not_reported': ['Телевізор ще не надіслав налаштування', 'Телевизор ещё не отправил настройки', 'TV has not reported yet'],
  'set.danger': ['Небезпечна зона', 'Опасная зона', 'Danger zone'],
  'set.clear_history': ['Очистити історію перегляду', 'Очистить историю просмотра', 'Clear watch history'],
  'set.clear_history_confirm': [
    'Видалити історію перегляду та позиції «продовжити»? Закладки і плейлисти залишаться.',
    'Удалить историю просмотра и позиции «продолжить»? Закладки и плейлисты останутся.',
    'Delete watch history and resume positions? Bookmarks and playlists stay.',
  ],
  'set.history_cleared': ['Історію очищено', 'История очищена', 'History cleared'],
  'set.delete_data': ['Видалити всі дані', 'Удалить все данные', 'Delete all data'],
  'set.delete_data_confirm': [
    'Видалити закладки, плейлисти, історію, позиції та налаштування профілю? PIN-код залишиться, усі пристрої буде розлогінено.',
    'Удалить закладки, плейлисты, историю, позиции и настройки профиля? PIN-код останется, все устройства будут разлогинены.',
    'Delete bookmarks, playlists, history, positions and profile settings? The PIN stays; every device is signed out.',
  ],
  'set.data_deleted': ['Усі дані видалено', 'Все данные удалены', 'All data deleted'],

  'common.auto': ['Авто', 'Авто', 'Auto'],
  'common.off': ['Вимкнено', 'Выключено', 'Off'],
